...
vrsbench_class_texts = [
    ["airplane"], ["airport"], ["baseball diamond"], ["basketball court"],
    ["bridge"], ["chimney"], ["container crane"], ["dam"],
    ["expressway service area"], ["expressway toll station"], ["golf field"], ["ground track field"],
    ["harbor"], ["helicopter"], ['helipad'], ["overpass"],
    ["roundabout"], ["ship"], ["soccer ball field"], ["stadium"],
    ["storage tank"], ["swimming pool"], ["tennis court"], ["train station"],
    ["vehicle"], ["windmill"]]

num_classes = len(vrsbench_class_texts)
num_training_classes = len(vrsbench_class_texts)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        class_text=vrsbench_class_texts,
