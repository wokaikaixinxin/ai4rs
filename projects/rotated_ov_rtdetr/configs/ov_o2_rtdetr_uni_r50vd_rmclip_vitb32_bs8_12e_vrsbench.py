...
from projects.rotated_ov_rtdetr.rotated_ov_rtdetr import (
    ...
    VRSBenchDetOneClassDataset, OBBRecallMetric)

with read_base():
    from configs._base_.default_runtime import *

load_from = 'work_dirs/ov_o2_rtdetr_r50vd_rmclip_vitb32_bs8_24e_vrsbench/epoch_24.pth'
...
train_dataloader = dict(
    ...
    pin_memory=True,
    dataset=dict(
        type=VRSBenchDetOneClassDataset,
