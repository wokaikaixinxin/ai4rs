...
from projects.rotated_ov_rtdetr.rotated_ov_rtdetr import (
    ...
    OpenCLIPLanguageBackbone, RotatedOVRTDETR, RotatedOVRTDETRHead, AVVGDetDataset)
...
num_classes = len(avvg_class_texts)
num_training_classes = len(avvg_class_texts)
...
default_hooks.update(
    checkpoint=dict(type='CheckpointHook', interval=1, max_keep_ckpts=13))
