...
from projects.rotated_ov_rtdetr.rotated_ov_rtdetr import (
    ...
    DIORRRSVGDetOneClassDataset, OBBRecallMetric)

with read_base():
    from configs._base_.default_runtime import *

load_from = '/root/mmrotate-1.x/work_dirs/ov_o2_rtdetr_r50vd_rmclip_vitb32_bs8_24e_dior_r_rsvg/epoch_24.pth'
...
train_dataloader = dict(
    ...
    batch_sampler=None,
    dataset=dict(
        type=DIORRRSVGDetOneClassDataset,
