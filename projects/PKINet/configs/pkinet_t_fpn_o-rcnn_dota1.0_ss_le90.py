...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='https://www.modelscope.cn/models/wokaikaixinxin/ai4rs/resolve/'
                       'master/PKINet/pkinet_t_pretrain.pth')),
    neck=dict(
        type='mmdet.FPN',
...
auto_scale_lr = dict(base_batch_size=4 * 4, enable=False)